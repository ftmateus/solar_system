...
function sphereUploadData(gl)
{
    ...
    sphere_texCoords_buffer = gl.createBuffer();
    gl.bindBuffer(gl.ARRAY_BUFFER, sphere_texCoords_buffer);
    gl.bufferData(gl.ARRAY_BUFFER, flatten(sphere_texCoords), gl.STATIC_DRAW);
}
...
function sphereDrawFilled(gl, program, texture)
{
    gl.useProgram(program);
